...
def generate_plenaries(plenaries_list):
    ...
    for plenary_dict in plenaries_list:
        ...
        if day not in plenaries:
            plenaries[day] = []
        plenaries[day].append(PlenarySession(id=plenary_dict['id'],
...
def generate_tutorials(tutorial_list):
    ...
    for tutorial_dict in tutorial_list:
        ...
        blocks = [SessionInfo(session_name=tutorial_dict['start_time'],
                              ...
                              link=None)]
        day = datetime.datetime.fromisoformat(tutorial_dict['start_time']).strftime("%A")
        final_tutorial = Tutorial(id=tutorial_dict['id'],
...
def generate_workshops(workshop_list):
    ...
    for workshop_dict in workshop_list:
        blocks = [SessionInfo(session_name=datetime.datetime.fromisoformat(workshop_dict['start_time']).strftime('%A'),
        ...
        final_workshop = Workshop(id=workshop_dict['id'],
